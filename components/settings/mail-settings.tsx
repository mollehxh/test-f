...
const fieldInputClass = "h-9 w-full rounded-2xl border border-border bg-transparent sm:w-72"
          ...
          <div className="flex flex-col gap-3 px-5 py-4">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground text-pretty">
                Список адресов, от которых приложение принимает архивы. Письма от
                других отправителей игнорируются.
              </p>
            </div>
            <EmailListEditor
              values={senders}
